// Change Order 01, Phase 5 — "Don't trust this page — check it," directly
// beneath the dot plot, where the eyes already are, not only at the bottom
// of the page. Exactly three links, nothing else — the full verification
// section (anchor chain, instrument hash, etc.) still lives further down
