...
// too small to read comfortably. Base bumped to text-base, labels to
// text-sm (still visually secondary, but legible on their own).
...
export default function ResultsFooter() {
  return (
    <footer className="border-t-4 border-ink px-6 py-10 font-mono text-base text-muted sm:px-10">
      <p className="text-sm font-bold tracking-widest text-ink uppercase">About this record</p>
      <p className="mt-2 max-w-4xl leading-relaxed">{BLOCK_1_ABOUT_THIS_RECORD}</p>

      <div className="mt-8 grid grid-cols-1 gap-8 sm:grid-cols-3">
        <div>
          <p className="text-sm font-bold tracking-widest text-ink uppercase">Results disclosure</p>
          <p className="mt-2 leading-relaxed">{BLOCK_2_RESULTS_DISCLOSURE}</p>
        </div>
        <div>
          <p className="text-sm font-bold tracking-widest text-ink uppercase">Not professional advice</p>
          <p className="mt-2 leading-relaxed">{BLOCK_3_NOT_PROFESSIONAL_ADVICE}</p>
        </div>
        <div>
          <p className="text-sm font-bold tracking-widest text-ink uppercase">Participant consent</p>
          <div className="mt-2">
            <ParticipantConsent />
          </div>
        </div>
      ...
      <div className="mt-10 border-t border-border pt-6">
        <p className="text-sm font-bold tracking-widest text-ink uppercase">Contact</p>
